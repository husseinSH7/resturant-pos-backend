      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold bg-linear-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
              Analytics Dashboard
            </h1>
          </div>
          <p className="text-sm text-gray-500 mt-2">Real-time insights into your restaurant performance</p>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 text-sm font-medium transition-all duration-200 hover:scale-105"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="space-y-3">
            {topItems.map((item, i) => (
              <div key={i} className="flex items-center justify-between p-4 bg-linear-to-r from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800 rounded-xl hover:from-gray-100 dark:hover:from-gray-700 transition-all duration-200">
                <div className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-linear-to-br from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 flex items-center justify-center">
              ...
              <div key={i} className="flex items-center justify-between p-4 bg-linear-to-r from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800 rounded-xl hover:from-gray-100 dark:hover:from-gray-700 transition-all duration-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{staff.orders} orders • ${staff.revenue.toLocaleString()}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 bg-yellow-50 dark:bg-yellow-900/30 px-3 py-1.5 rounded-full">
                  <span className="text-yellow-500">★</span>
                  <span className="font-bold text-yellow-700 dark:text-yellow-400">{staff.rating}</span>
                </div>
              </div>
            ))}
          </div>
